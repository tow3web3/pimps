...
function StatusChip({ row }: { row: Row }) {
  if (row.kind === "funded")
    return (
      <span className="chip !text-[var(--violet)] !border-[rgba(255,162,107,0.45)]">◆ funded</span>
    );
  ...
  return <span className="chip !text-[var(--cyan)] !border-[rgba(255,90,0,0.4)]">● live</span>;
}
        ...
        <div className="flex items-end justify-between flex-wrap gap-3">
          ...
          {board && (
            <div className="flex gap-2 flex-wrap">
              ...
              <span className="chip !text-[var(--cyan)] !border-[rgba(255,90,0,0.35)]">
                {board.stats.live} live
              </span>
              {board.stats.funded > 0 && (
                <span className="chip !text-[var(--violet)] !border-[rgba(255,162,107,0.4)]">
              ...
              {podium.map((r, i) => (
                <div
                  ...
                  className={`glass p-3 md:p-4 text-center ${
                    i === 0 ? "!border-[rgba(255,90,0,0.45)]" : ""
                  } ${r.isYou ? "!border-[rgba(255,90,0,0.6)]" : ""}`}
                >
