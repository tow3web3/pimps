    ...
    <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-[180px]" role="img" aria-label="equity curve">
      <defs>
        <linearGradient id="eq-fill" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="rgba(255,90,0,0.28)" />
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto p-4 md:p-6 space-y-4">
            ...
            return (
              <div
                ...
                className={`glass glass-hover p-5 relative overflow-hidden ${
                  st === "live" ? "!border-[rgba(255,90,0,0.4)]" : ""
                  ...
                  <span
                    className={`chip ${
                      st === "cleared"
                        ...
                        : st === "live"
                          ? "!text-[var(--cyan)] !border-[rgba(255,90,0,0.4)]"
                          : ""
                    }`}
                  >
        ...
        <div className="glass p-5">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/terminal" className="chip hover:!text-[var(--cyan)] hover:!border-[rgba(255,90,0,0.4)] transition-colors">
              open terminal ▸
            </Link>
          </div>
          <EquityCurve />
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-3">
          ...
          <div className="glass p-5 flex flex-col justify-between !border-[rgba(255,162,107,0.3)]">
            <div>
              ...
              <span
                className={`chip self-start mt-3 ${
                  game.lastPayment.method === "gf"
                    ? "!text-[var(--violet)] !border-[rgba(255,162,107,0.45)]"
                    : ""
                }`}
              >
