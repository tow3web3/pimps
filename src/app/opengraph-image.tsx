    ...
    (
      <div
        style={{
          ...
          padding: "0 80px",
          background:
            "radial-gradient(900px 500px at 20% 0%, rgba(34,211,238,0.16), transparent 60%), radial-gradient(900px 600px at 90% 110%, rgba(167,139,250,0.18), transparent 60%), #05060b",
          color: "#e7ecf8",
